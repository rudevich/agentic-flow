#!/usr/bin/env node
import { MIN_NODE_MAJOR, PREFIX } from '../src/constants.ts';
import { config, init } from '../src/commands/init.ts';
import { ownPackage } from '../src/project.ts';
import { reset } from '../src/commands/reset.ts';
import { addSource } from '../src/commands/source.ts';
import { nodeAtLeast } from '../src/utils.ts';
